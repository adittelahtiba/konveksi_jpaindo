...
<div class="bcrumbs">
    <div class="container">
        <ul>
            ...
            <li><a href="<?= base_url('pesanpakaian/pola/') . $KodeJenis; ?>">Pilih Pola</a></li>
            <li><a href="<?= base_url('pesanpakaian/desain/') . $KodeJenis . '/' . $KodeJenis2; ?>">Pilih Desain</a></li>
            <li><a href="./pilih-desain.html"></a>Detail Barang</li>
        </ul>
    </div>
</div>
                                        ...
                                        <table class="table sm">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>Deskripsi</td>
                                                    <td>
                                                        <textarea name="Deskripsi" placeholder="Pesanan ini harus selesai pada tanggal..." class="form-control"><?= set_value('Deskripsi'); ?></textarea>
